...
file_upload = st.file_uploader(":red[Please upload an image and then choose an option from the dropdown box on the left to upload or view or edit the information on the card.]", type=["jpg", "jpeg", "png"])


# Create a sidebar menu with options to Add, Show, Update business card information
st.sidebar.title(":red[BIZCARD-X]")
st.sidebar.image("bizz.gif", width=300)
